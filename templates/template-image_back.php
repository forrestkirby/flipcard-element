...
if ($props['image_back']) {
    ...
    $image_back = $this->el('image', [
        ...
        'class' => [
            ...
            'uk-box-shadow-hover-{image_back_hover_box_shadow} {@!panel_back_style} {@link_back_type} {@!image_back_transition}' => $props['link_back'],
            'uk-transition-{image_back_transition} uk-transition-opaque {@link_back_type}' => $props['link_back'],
